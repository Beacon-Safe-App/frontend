...
function BystanderReport() {
    ...
    return (
        <div className="bystander-report-container">
            ...
            <p className="tool-p">Here, you can create a flag for any instance of threat or violence that you personally witness.<br></br><br></br>Use the flag icon to log your current location with date, time, and the ability to assign the instance to add images and/or notes regarding the incident you have witnessed or are witnessing.</p>
        </div>
    );
}

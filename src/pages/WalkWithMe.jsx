  ...
  return (
    <div className="walk-with-me-container">
      ...
      <div className="content-overlay">
        ...
        />
        <p className="tool-p">
          This "walk with me" feature sets a timer for your safe arrival. When
          it ends, you'll need to enter your PIN to deactivate it. If not, your
          phone will switch to emergency mode.
        </p>
